...
from modules.dist_qwen_pp_module import *
...
class GpipeAsync:
    ...
    def __init__(self, args, config, device, use_dp=False,
                 _StageFirst=Qwen2StageFirst, _StageLast=Qwen2StageLast,
                 _StageMiddle=Qwen2StageMiddle):
...
#             )
        ...
        self.forward_compressor = get_compressor(
            ...
            high_precision_allocation_ratio=args.high_precision_allocation_ratio,
        )
        ...
        self.backward_compressor = get_compressor(
            ...
            tile_size=args.backward_tile_size,
        )
